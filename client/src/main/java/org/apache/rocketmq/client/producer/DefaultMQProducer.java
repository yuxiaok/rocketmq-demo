...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
    ...
    /**
     * Producer group conceptually aggregates all asyncproducer instances of exactly same role, which is particularly
    ...
    /**
     * Constructor specifying both asyncproducer group and RPC hook.
     *
    ...
    /**
     * Constructor specifying asyncproducer group, RPC hook, enabled msgTrace flag and customized trace topic name.
     *
     * @param producerGroup        Producer group, see the name-sake field.
     * @param rpcHook              RPC hook to execute per each remoting command execution.
    ...
    /**
     * Constructor specifying asyncproducer group.
     *
     * @param producerGroup Producer group, see the name-sake field.
     */
    ...
    /**
     * Constructor specifying asyncproducer group and enabled msg trace flag.
     *
     * @param producerGroup  Producer group, see the name-sake field.
     * @param enableMsgTrace Switch flag instance for message trace.
     */
    ...
    /**
     * Constructor specifying asyncproducer group, enabled msgTrace flag and customized trace topic name.
     *
     * @param producerGroup        Producer group, see the name-sake field.
     * @param enableMsgTrace       Switch flag instance for message trace.
     * @param customizedTraceTopic The name value of message trace topic.If you don't config,you can use the default trace topic name.
    ...
    /**
     * Start this asyncproducer instance.
     * </p>
     *
     * <strong>
    ...
    /**
     * This method shuts down this asyncproducer instance and releases related resources.
     */
    @Override
